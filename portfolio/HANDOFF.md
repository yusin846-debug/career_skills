...
- 사용자: 김유신. 플랜즈 참여·업무 기간은 2017–2026년(약 9년), B2B 영업 주력은 2019년부터. CRM·데이터·AI에 관심을 넓히되 특정 산업으로 기회를 한정하지 않음.
- 경력 기준(2026-09-13 본인 정정): 2017년의 정확한 시작 월은 미확인. 이사 급여는 2018년 4월부터, 본인이 전달한 고용보험 기간은 2018.04.16–2026.04.01. 참여 기간·급여·보험 기간·직함 재임 기간을 구분하고 보험 원본 검증 완료로 설명하지 않음. 이전 학원 업무·다른 스타트업 경력은 플랜즈 기간에 합산하지 않음.
