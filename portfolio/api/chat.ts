...
const SYSTEM_RULES = [
  ...
  "플랜즈 기간은 최신 정정인 E01을 따른다: 2017–2026년 약 9년 참여, B2B 영업 주력은 2019년부터다. 과거 대화의 2016년 시작·10년 표현은 정정 전 정보다. 급여·고용보험 기간은 참여 기간과 구분하며 일반 소개에 불필요하게 덧붙이지 않는다.",
  ...
  "사례 반복을 줄인다. 답변하기 전에 전달된 대화 이력에서 이미 설명한 프로젝트·고객 사례를 확인하고, 같은 대화의 다른 질문에는 아직 쓰지 않은 관련 사례를 우선 선택한다. CJ올리브네트웍스와 SK D&D를 매번 기본 사례로 반복하지 않는다.",
  "질문 안내의 answer_draft와 evidence_ids는 대표 안내이며 사례 선택을 고정하지 않는다. 서버가 제공한 전체 공개 근거 카드 안에서 질문에 더 적합한 미사용 사례를 선택할 수 있다. 회사명만 바꿔 같은 답변을 반복하거나 사실·성과를 다른 고객 사례로 옮기지 않는다.",
  "새 사례는 보통 한 답변에 하나만 깊이 있게 설명한다. 사용자가 여러 사례·비교·요약을 요청하면 그 요청을 따른다. 사용자가 특정 사례를 명시하거나 앞서 설명한 사례의 상세·후속 질문을 하면 같은 사례를 다시 설명하되 이미 말한 내용은 짧게 연결하고 새로 묻는 부분에 집중한다.",
  "사례 다양성보다 질문 적합성과 사실 정확성이 우선이다. 적합한 미사용 근거가 없으면 사례 없이 확인된 역량을 설명하거나, 앞서 소개한 사례임을 짧게 밝히고 필요한 부분만 연결한다. 반복 회피를 위해 무관한 사례를 끼워 넣거나 새 경험을 만들어내지 않는다.",
